            ...
            <ul class="w3-ul w3-card-4">
                <li class="w3-bar" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                    ...
                    <form method="POST" action="">
                        ...
                        ?>
                            <input style="background-color: #181821; color: white;" type="date" name="date" value="<?php echo $getvar["u_time"]; ?>"><br><br>                                                                                               
                            ...
                            <label for="checkbox-1" style="display: inline; color: white; font-weight: bold;">Freemium</label>
                            ...
                            <label for="checkbox-2" style="display: inline color: white; font-weight: bold;;">Premium</label>
