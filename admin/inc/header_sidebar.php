        ...
        <li <?php if ($page_title == 'Panel') {
            ...
            <li php
                ...
                <ul>
                    ...
                    <li><a style="" <?php if ($page_title === "Seri No") echo 'style="color: #83d8ae !important;"' ?> href="/vergidairesi"><i class="fa fa-arrow-right"></i>Vergi Dairesi Sorgu</a></li>
            ...
            <li php
                ...
                <ul>
                    <li><a style=" !important;" <?php if ($page_title === "Okul Vesikalık Sorgu") echo 'style="color: #fff !important;"' ?> href="/eksi18vesika"><i class="fa fa-arrow-right"></i>-18 Vesika Sorgu</a></li>
                    <li><a style=" !important;" <?php if ($page_title === "Okul Vesikalık Sorgu") echo 'style="color: #fff !important;"' ?> href="/vesika"><i class="fa fa-arrow-right"></i>+18 Vesika Sorgu</a></li>
                </ul>
            </li>
            <li php
                if (
            ...
            <li <?php
                ...
                <ul>
                    ...
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/kimlikolusturucu"><i class="fa fa-arrow-right"></i>Kimlik Oluşturucu</a></li>
                    ...
                    <li><a style="color: #9a9cab;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/file"><i class="fa fa-arrow-right"></i>Dosyalar (Bakım)</a></li>
